...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/arte-stripe-checkout
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/arte-stripe-checkout_test
```
